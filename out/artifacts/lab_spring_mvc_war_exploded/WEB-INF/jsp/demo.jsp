...
<div class="mainDiv">
    <form:form action="">
        <div id="generalInfoDiv" class="container">
            ...
            <div class="row">
                <div class="col"><img src="./images/gameicon/feibiao2.png"><span style="font-size: 120%; font-weight: bolder">風魔</span></div>
                <div class="col"><span>被誉为隐秘修炼者的迷之忍者众,擅长幻术与伪装</span></div>
            </div>
            <div class="row">
                <div class="col"><img src="./images/gameicon/feibiao2.png"><span style="font-size: 120%; font-weight: bolder">轩辕</span></div>
